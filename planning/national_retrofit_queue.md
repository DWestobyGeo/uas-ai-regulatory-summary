...
| 10 | MI (Michigan) | 1 | 15 | 10 | no | no | legacy state (no manifest, no checklist); 1 low-confidence record(s); 1 proposed/pending/failed/superseded record(s); 3 criminal/felony-restriction record(s); 5 registration/licensing/permit/procurement record(s); 1 secondary-source-controlling record(s); 10 authorities (>= 10) |
| 11 | NY (New York) | 1 | 15 | 8 | no | no | legacy state (no manifest, no checklist); 2 low-confidence record(s); 3 proposed/pending/failed/superseded record(s); 2 criminal/felony-restriction record(s); 4 registration/licensing/permit/procurement record(s); 1 secondary-source-controlling record(s) |
| 12 | UT (Utah) | 1 | 15 | 15 | no | yes | 1 proposed/pending/failed/superseded record(s); 6 criminal/felony-restriction record(s); 7 registration/licensing/permit/procurement record(s); 15 authorities (>= 10) |
